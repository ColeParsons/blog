    ...
    if(in_array($fileActualExt, $allowed)){
        ...
        if($fileError === 0){
            ...
            $fileDestination = 'uploads/'.$fileNameNew;
                ...
                $s=INSERT INTO posts(`imageName`)([$fileDestination]);
                ...
                if(mysqli_num_rows($res) > 0 ) {
                    ...
                    while ($row = mysqli_fetch_assoc($res)) {
                        ...
                        if($category=="poetry" || $category=="Poetry"){
                            $up .= "<a class='demo shareSelector' <a class='eh3' style='' href='javascript:;' ><h2 class='eh4' href=''> Category: $category</h2><h1 style='color:cyan; text-align:center; '>$title</h1><h3 >$date</h3><h2 class='eh4'>$output</h2><img src = \"$fileDestination\" ></a></a>
<hr>";
                ...
                echo"you fucked up again broooo";
            }
