...
if(mysqli_num_rows($res) > 0) {
    while ($row = mysqli_fetch_assoc($res)) {
        ...
        if($category=="mindbodysoul" || $category=="MindBodySoul"){
            $mbs .= "<a class='demo shareSelector' <a class='eh3' style='' href='javascript:;' ><h2 class='eh4' href=''> Category: $category</h2><h1 style='color:cyan; text-align:center; '>$title</h1><h3 >$date</h3><h2 class='eh4'>$output</h2></a></a>
<hr>";
        }
    }
}
...
<table class="myclass" style="margin-left:140px;  margin-right:180px; width:67%; margin-top:-420px; border-left:3px solid white; border-right:3px solid white; border-top:3px solid white; border-bottom:3px solid white; display:inline-block;">
    <td class="demo shareSelector" >
        <a><?php
            $newtext2 = wordwrap($mbs, 65, "\n", true);
            echo"<a href='' >.$newtext2.";?> </a>
    </td>
    </tr>
</table>
</body>
